...
<body>
    ...
    <div class="col-9 py-3 px-4 float-start">
        <h2 class="text-center my-5">Coustmer users</h2>
            ...
            <?php 
                $select_data = mysqli_query($conn, "SELECT * FROM `user` WHERE user_type = 'admin'") or die("query failed");
                    ...
                    while($row = mysqli_fetch_assoc($select_data)){ ?>
                        ...
                        <tbody>
                            <tr class="text-center align-middle">
                                ...
                                <td>
                                    <a href="admin_user.php?delete=<?php echo $row['id'];?>" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        </tbody>
